...
<h2 class="users-head-entry"><a href="#social">{USRSOCIAL}</a></h2>
<div class="user-form-opened"> {SOCIAL}</div>




<h2 class="users-head-entry"><a href="#login">{USERSLOG}</a> </h2>
<div id="#login">
<form  method="post" action="{TARGET}" class="user-form">
...
<h2 class="users-head-entry"><a href="#signin">{USERREG}</a></h2>
<div>
<form  method="post" action="{TARGET}" class="user-form">
    <table border="0" cellpadding="2" cellspacing="5" width="80%" align="center"  > 
