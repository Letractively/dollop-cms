...
<form method="post" action="#{$sector}" target="_self">
  ...
  <tr>
  <th>Title</th> <td><input type="text" value="{$title}" name="name" readonly></td>
  <td width="30%">
...
<form method="post" action="#{$sector}" target="_self">
  ...
  <td>
        ...
        <input type="text" value="" name="name" id="text_only"><br />
        <small>this is folder name and only text and "_" is allowed</small>
  </td>
  <td width="30%">
    <font style="font-family: DinBoldWebfont, 'Arial Black', Gadget, sans-serif !important;text-transform: uppercase;font-size: 16px;font-weight: bold;">
    {$language['md.cat.type']}
  ...
  <small>this is the size of creoped images</small>
  </td>
  </tr> 
<tr>
  <td colspan="3" align="center">
