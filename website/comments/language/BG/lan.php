...
global $language;
$language['md.usr.loglnk'] = "Login";
$language['md.usr.logtxt'] = 'to post comments here.<br /><br /> ';
$language['md.empty.comm'] = "No comments yet.";
$language['md.com.title']="Post Your Comment & Contribute!";
