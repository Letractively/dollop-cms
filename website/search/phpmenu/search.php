...
if (isset($destination)) {
  ...
  <form id="searchform" method="post" action="{$destination}" >
        ...
        <div class="menu-content">
            <input type="hidden" value="{$name_table}" name="{$table}" />
            <input id="search"  type="text" name="{$query}" value="{$value}" placeholder="{$language['lw.search']}" type="text" lang="{$code}"  x-webkit-speech  speech  onwebkitspeechchange="this.form.submit();"   />
        </div>
  </form>
  </div>
